    ...
    <div className="profile-card">
      <div className="profile-info">
        ...
        <div className="profile-details">
          ...
          <ul>
            <li><span>☕</span> Lucky to just code</li>
            <li><span>🌍</span> From Ghaziabad ,India</li>
            <li><span>💼</span> Student at Bits Pilani'25</li>
          ...
          <div className="social-links">
            ...
            <a href="https://github.com/noobapoo99" target="_blank" rel="noopener noreferrer">
            <img width="35" height="35" src="https://img.icons8.com/glyph-neue/64/github.png" alt="github"/>
            </a>
            <a href="https://www.linkedin.com/in/apoorv-nath-tripathi-787848231/" target="_blank" rel="noopener noreferrer">
            <img width="35" height="35" src="https://img.icons8.com/ios/50/linkedin.png" alt="linkedin"/>
            </a>
            <a href="https://www.instagram.com/apoorvnathtripathi/" target="_blank" rel="noopener noreferrer">
            <img width="35" height="35" src="https://img.icons8.com/ios/500/instagram-new--v1.png" alt="instagram-new--v1"/>
            </a>
          </div>
        </div>
      </div>
      <div className="profile-info">
        ...
        <div className="profile-details">
          ...
          <ul>
            ...
            <li><span>🌍</span> from Varanasi ,India</li>
            <li><span>💼</span> Student at Bits Pilani'25</li>
          ...
          <div className="social-links">
            ...
            <a href="https://github.com/medhruv27" target="_blank" rel="noopener noreferrer">        
                <img width="35" height="35" src="https://img.icons8.com/glyph-neue/64/github.png" alt="github"/>
                </a>
            <a href="https://www.linkedin.com/in/dhruv-verma-59659722b/" target="_blank" rel="noopener noreferrer">
            <img width="35" height="35" src="https://img.icons8.com/ios/50/linkedin.png" alt="linkedin"/>
            </a>
            <a href="https://www.instagram.com/me_dhruv._/" target="_blank" rel="noopener noreferrer">
            <img width="35" height="35" src="https://img.icons8.com/ios/500/instagram-new--v1.png" alt="instagram-new--v1"/>
            </a>
          </div>
        </div>
